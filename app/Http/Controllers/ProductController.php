...
class ProductController extends Controller
{
    ...
    public function productData(Request $request)
    {
        ...
        if(!empty($products))
        {
            foreach ($products as $key=>$product)
            {
                ...
                // add into response
                $nestedData['purchase_percentage'] = $product->purchase_percentage;
                $nestedData['sale_percentage'] = $product->sale_percentage;
    ...
    public function store(Request $request)
    {
        ...
        // $data['purchase_percentage'] = $data['purchase_percent'];
        // $data['sale_percentage'] = $data['sale_percent'];
        
        if(array_key_exists("purchase_percent", $data))
                $data['purchase_percentage'] = $data['purchase_percent'];
    ...
    public function saleUnitDetail($id)
    {
