                                        ...
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="col-sm-2"><?php echo e(trans('file.Percent %')); ?></th>
...
function addNewProduct(data){
    ...
    cols += '<td class="col-sm-2"><input type="text" name="percent[]" class="form-control percent numkey input-number percent-text" value="0" step="any" required></td>';
