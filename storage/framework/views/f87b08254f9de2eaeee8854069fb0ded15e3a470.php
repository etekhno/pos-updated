            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($unit->id); ?>">
                    ...
                    <?php else: ?>
                        <td>N/A</td>
                    <?php endif; ?>
                    <?php if($unit->percent_or_fix): ?>
                        <td> <?php if($unit->operation_value == true): ?> <input type="checkbox" checked disabled/> <?php endif; ?> </td>
                    <?php else: ?>
                        <td>N/A</td>
                    <?php endif; ?>
                    <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label><?php echo e(trans('file.Click if Only sale on percentage')); ?> </label>
                        <?php echo e(Form::checkbox('percent_or_fix',true, null, array('class' => 'form-control'))); ?>
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <form>
                ...
                <div class="form-group">
                    <label><?php echo e(trans('file.Click if Only sale on percentage')); ?> </label>
                    <?php echo e(Form::hidden('percent_or_fix', false)); ?>
...
<div id="importUnit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <p><?php echo e(trans('file.The correct column order is')); ?> (unit_code*, unit_name*, percent_or_fix, base_unit [unit code], operator, operation_value) <?php echo e(trans('file.and you must follow this')); ?>.</p>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
...
$(document).ready(function() {
    $('.open-EditUnitDialog').on('click', function() {
        ...
        $.get(url, function(data) {
            ...
            $("input[name='percent_or_fix']").prop('checked', data['percent_or_fix']);
