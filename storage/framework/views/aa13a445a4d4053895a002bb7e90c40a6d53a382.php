      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            ...
            <p>&copy; <?php echo e($general_setting->site_title); ?> | <?php echo e(trans('file.Developed By')); ?> <a target="_blank" href="https://dedeveloperz.com/" class="external">Dedeveloperz</a></p>
          </div>
            </div>
          </div>
        </div>
