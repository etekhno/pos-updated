                                        ...
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="col-sm-2"><?php echo e(trans('file. % / Fix')); ?></th>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <label><?php echo e(trans('file.Due Amount')); ?> : </label>

                                            <b><p id="due" class="ml-2" style="color:red;">0.00</p></b>
                        ...
                        <table id="product-table" class="table no-shadow product-list">
                            ...
                            <?php for($i=0; $i < ceil($product_number/5); $i++): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[0+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[0+$i*5]->code . ' (' . $lims_product_list[0+$i*5]->name . ')'); ?>"><p><b><u><?php echo e($lims_product_list[0+$i*5]->product_details); ?></u></b></p><img  src="<?php echo e(url('public/images/product',$lims_product_list[0+$i*5]->base_image)); ?>" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[1+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[1+$i*5]->code . ' (' . $lims_product_list[1+$i*5]->name . ')'); ?>"><p><b><u><?php echo e($lims_product_list[1+$i*5]->product_details); ?></u></b></p><img  src="<?php echo e(url('public/images/product',$lims_product_list[1+$i*5]->base_image)); ?>" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[2+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[2+$i*5]->code . ' (' . $lims_product_list[2+$i*5]->name . ')'); ?>"><p><b><u><?php echo e($lims_product_list[2+$i*5]->product_details); ?></u></b></p><img  src="<?php echo e(url('public/images/product',$lims_product_list[2+$i*5]->base_image)); ?>" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[3+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[3+$i*5]->code . ' (' . $lims_product_list[3+$i*5]->name . ')'); ?>"><p><b><u><?php echo e($lims_product_list[3+$i*5]->product_details); ?></u></b></p><img  src="<?php echo e(url('public/images/product',$lims_product_list[3+$i*5]->base_image)); ?>" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[4+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[4+$i*5]->code . ' (' . $lims_product_list[4+$i*5]->name . ')'); ?>"><p><b><u><?php echo e($lims_product_list[4+$i*5]->product_details); ?></u></b></p><img  src="<?php echo e(url('public/images/product',$lims_product_list[4+$i*5]->base_image)); ?>" width="100%" />
    ...
    if (Object.keys(data).length != 0) {
        ...
        $.each(data['name'], function(index) {
            ...
            if(index % 5 == 0 && index != 0)
                ...
                tableData += '</tr><tr><td class="product-img sound-btn" title="'+data['name'][index]+'" data-product = "'+product_info+'"><p><b>'+data['product_details'][index]+'</b></p><img  src="public/images/product/'+data['image'][index]+'" width="100%" /><p>'+data['name'][index]+'</p><span>'+data['code'][index]+'</span></td>';
                ...
                tableData += '<td class="product-img sound-btn" title="'+data['name'][index]+'" data-product = "'+product_info+'"><p><b>'+data['product_details'][index]+'</b></p><img  src="public/images/product/'+data['image'][index]+'" width="100%" /><p>'+data['name'][index]+'</p><span>'+data['code'][index]+'</span></td>';
...
$('select[name="customer_id"]').on('change', function() {
    ...
    $.get('report/dues_by_customerId/' + id, function(dues){
    if(dues>0)
        alert('Already Due Amount: ' + dues);
    });
...
$('#myTable').keyboard({
        ...
        accepted : function(event, keyboard, el) {
            ...
            if(el.name=='percent[]'){
                product_discount[rowindex] = el.value;
...
$("#myTable").on('input', '.percent', function() {

rowindex = $(this).closest('tr').index();

product_discount[rowindex] = $(this).val();
...
$("table.order-list tbody").on("click", ".ibtnDel", function(event) {
    ...
    product_discount_total.splice(rowindex, 1);
...
function change(paying_amount, paid_amount) {
    ...
    // $("#due").text( (parseFloat( paying_amount - paid_amount ) * -1).toFixed(2));

    $("#change").text( parseFloat(paying_amount - paid_amount).toFixed(2) > 0.0 ? parseFloat(paying_amount - paid_amount).toFixed(2) : 0.0 );

    $("#due").text( parseFloat(paying_amount - paid_amount).toFixed(2) < 0.0 ? (parseFloat(paying_amount - paid_amount)*-1).toFixed(2) : 0.0 );
...
console.log(data)
    ...
    // treated as prof
    temp_product_discount = data[13] == null ? 0 : data[13];

    cols += '<td class="col-sm-3 product-title"><button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"><strong>' + data[0] + '</strong></button> [' + data[1] + '] </td>';
    ...
    cols += '<td class="col-sm-2"><input type="text" name="percent[]" class="form-control percent numkey input-number percent-text" value="' + temp_product_discount + '" step="any" required></td>';
    ...
    cols += '<input type="hidden" class="sale-on-percent-or-fix" name="sale_on_percent_or_fix[]" value="' + temp_unit_sale_percent_or_fix[0] + '"/>';
    ...
    if(keyboard_active==1){
        ...
        $("table.order-list tbody").append(newRow).find('.percent').keyboard({usePreview: false, layout: 'custom', display: { 'accept'  : '&#10004;', 'cancel'  : '&#10006;' },
        customLayout : {'normal' : ['1 2 3', '4 5 6', '7 8 9','0 {dec} {bksp}','{clear} {cancel} {accept}']}, 
        restrictInput : true, preventPaste : true, autoAccept : true, 
    ...
    product_discount.push(temp_product_discount);
    product_discount_total.push('0.00');
...
function checkQuantity(sale_qty, flag) {
    ...
    if(!flag){
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.percent').val(product_discount[rowindex]);
...
function calculateRowProductData(quantity) {
    ...
    if(product_type[pos] == 'standard')
        ...
        // console.log("price: " + row_product_price + "quantity: " + quantity);
        // console.log("sale: " + (row_product_price + (row_product_price * product_discount[rowindex] / 100)));
    ...
    if (tax_method[rowindex] == 1) {
        ...
        if(sale_on_percent_or_fix){
            if(sale_on_percent_or_fix == true){
                // product_discount is actually treated as profit
                product_discount_total[rowindex] = quantity * product_discount[rowindex];
                sub_total += (sub_total * product_discount[rowindex] / 100);
            }
        }else{
...
function calculateTotal() {
    ...
    total_discount = 0;
    $("table.order-list tbody .discount-value-total").each(function() {
...
function cancel(rownumber) {
    ...
    while(rownumber >= 0) {
        ...
        unit_percent_or_fix.pop();

        unit_purchase_percent.pop();
        unit_sale_percent.pop();
...
$(document).on('submit', '.payment-form', function(e) {
    ...
    if( parseFloat( $('input[name="paying_amount"]').val() ) < parseFloat( $('input[name="paid_amount"]').val() ) )
