                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" disabled name="percent_or_fix" class="form-control">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="sale_percent" disabled class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="purchase_percent" disabled class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
