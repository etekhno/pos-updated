    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
{{--               <p>&copy; {{$general_setting->site_title}} | {{trans('file.Developed')}} {{trans('file.By')}} <a href="https://lion-coders.com" class="external">GTechPK</a></p>
            <div class="copyrights text-center"> --}}
            <p>&copy; {{$general_setting->site_title}} | {{trans('file.Developed By')}} Madina Developer </p>
          </div>
            </div>
          </div>
        </div>
