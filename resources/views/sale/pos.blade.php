                                        ...
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="col-sm-2">{{trans('file. % / Fix')}}</th>
                        ...
                        <table id="product-table" class="table no-shadow product-list">
                            ...
                            @for ($i=0; $i < ceil($product_number/5); $i++)
                                ...
                                <tr>
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[0+$i*5]->name}}" data-product ="{{$lims_product_list[0+$i*5]->code . ' (' . $lims_product_list[0+$i*5]->name . ')'}}"><p><b><u>{{$lims_product_list[0+$i*5]->product_details}}</u></b></p><img  src="{{url('public/images/product',$lims_product_list[0+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[1+$i*5]->name}}" data-product ="{{$lims_product_list[1+$i*5]->code . ' (' . $lims_product_list[1+$i*5]->name . ')'}}"><p><b><u>{{$lims_product_list[1+$i*5]->product_details}}</u></b></p><img  src="{{url('public/images/product',$lims_product_list[1+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[2+$i*5]->name}}" data-product ="{{$lims_product_list[2+$i*5]->code . ' (' . $lims_product_list[2+$i*5]->name . ')'}}"><p><b><u>{{$lims_product_list[2+$i*5]->product_details}}</u></b></p><img  src="{{url('public/images/product',$lims_product_list[2+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[3+$i*5]->name}}" data-product ="{{$lims_product_list[3+$i*5]->code . ' (' . $lims_product_list[3+$i*5]->name . ')'}}"><p><b><u>{{$lims_product_list[3+$i*5]->product_details}}</u></b></p><img  src="{{url('public/images/product',$lims_product_list[3+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[4+$i*5]->name}}" data-product ="{{$lims_product_list[4+$i*5]->code . ' (' . $lims_product_list[4+$i*5]->name . ')'}}"><p><b><u>{{$lims_product_list[4+$i*5]->product_details}}</u></b></p><img  src="{{url('public/images/product',$lims_product_list[4+$i*5]->base_image)}}" width="100%" />
