                            ...
                            @if($empty_database_permission_active)
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <a class="form-control empty-db" onclick="return confirm('Are you sure want to delete? If you do this all of your data will be lost.')" href="{{route('setting.emptyDatabase')}}"><i class="dripicons-stack "></i> {{trans('file.Empty Database')}}</a>
                                    </div>
                                </div>
                            @endif
                            </div>
