                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Unit Sale/Purchase on %')}} </strong> </label>
                                        <input type="checkbox" disabled name="percent_or_fix" checked="{{$lims_product_data->sale_percentage}}" required class="form-control">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('file.Sale %')}} </strong> </label>
                                        <input type="number" name="sale_percent" value="{{$lims_product_data->sale_percentage}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('file.Purchase %')}} </strong> </label>
                                        <input type="number" name="purchase_percent" value="{{$lims_product_data->purchase_percentage}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
