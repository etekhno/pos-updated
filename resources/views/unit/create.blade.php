            ...
            <tbody>
                ...
                <tr data-id="{{$unit->id}}">
                    ...
                    @else
                        <td>N/A</td>
                    @endif
                    @if($unit->percent_or_fix)
                        <td> @if($unit->operation_value == true) <input type="checkbox" checked disabled/> @endif </td>
                    @else
                        <td>N/A</td>
                    @endif
                    <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label>{{trans('file.Click if Only sale on percentage')}} </label>
                        {{Form::checkbox('percent_or_fix',true, null, array('class' => 'form-control'))}}
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <form>
                ...
                <div class="form-group">
                    <label>{{trans('file.Click if Only sale on percentage')}} </label>
                    {{Form::hidden('percent_or_fix', false)}}
                    {{Form::checkbox('percent_or_fix',true, null, array('class' => 'form-control'))}}
                </div>
                <div class="form-group">
                    <label>{{trans('file.Base Unit')}}</label>
...
<div id="importUnit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <p>{{trans('file.The correct column order is')}} (unit_code*, unit_name*, percent_or_fix, base_unit [unit code], operator, operation_value) {{trans('file.and you must follow this')}}.</p>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
